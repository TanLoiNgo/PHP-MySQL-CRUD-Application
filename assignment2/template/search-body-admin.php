...
$itemList_Sql = mysqli_query($db_con, "SELECT * from items");
$itemList = array();
...
<div id="item">
    <div id="sideCategory">
        ...
        <div>
            <?php foreach ($categoryList as $category) { ?>
                <a href="./view-item-admin.php?cat-name=<?php echo $category["name"]; ?>"
    ...
    <div>
        <div>
            <h1 id="h1-Search">Search for <?php if( !empty($_GET['search'])){echo $_GET['search']; } ?></h1>
            <form id="search-form" action="search-admin.php" method="get" enctype="multipart/form-data">
            ...
            if (!empty($searchThis)) {
                ...
                for ($i = 0; $i < count($itemList); $i++) {
                    for ($split = 0; $split < count($breakStrings); $split++) {
                        ...
                        $description = strtolower($itemList[$i]['description']);
                                ...
                                <div class="itemList_search">
                                    ...
                                    <div class="item-text">
                                        ...
                                        <div>
                                            ...
                                            <a class="black-btn"
                                               href="./delete-item.php?item-id=<?php echo $itemList[$i]['id'] ?>">Delete</a>
                                        </div>
